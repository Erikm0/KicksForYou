    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-2" id="szuro">
                ...
                $sql = "SELECT * FROM cipo WHERE marka = 'nike' GROUP BY nev ORDER BY id ASC";
                ...
                if (isset($_SESSION['selectedMeretek'])) {
                    ...
                    $szinekQuery = "SELECT DISTINCT szin FROM cipo WHERE marka = 'nike' AND $meretCondition ORDER BY szin ASC";
                } else {
                    $szinekQuery = "SELECT DISTINCT szin FROM cipo WHERE marka = 'nike' ORDER BY szin ASC";
                }
                ...
                if (isset($_SESSION['selectedSzinek'])) {
                    ...
                    $meretekQuery = "SELECT DISTINCT meret FROM cipo WHERE marka = 'nike' AND $szinCondition ORDER BY meret ASC";
                } else {
                    $meretekQuery = "SELECT DISTINCT meret FROM cipo WHERE marka = 'nike' ORDER BY meret ASC";
                }
                ...
                $sql = "SELECT * FROM cipo WHERE marka = 'nike'";
